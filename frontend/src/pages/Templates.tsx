...
const TEMPLATES = [
  ...
  { key: 'bohem', name: 'Bohem Kır', category: 'Kır', c1: '#5f7050', c2: '#cdbfa6', dark: false },
  { key: 'lacivert', name: 'Lacivert Gece', category: 'Düğün', c1: '#0e1a33', c2: '#c9a14e', dark: true },
  { key: 'lavanta', name: 'Lavanta Bahçe', category: 'Bahçe', c1: '#6f54a0', c2: '#e3d6f3', dark: false },
  { key: 'sonbahar', name: 'Sonbahar', category: 'Kır', c1: '#8a3d1c', c2: '#ecd9bf', dark: false },
  { key: 'deniz', name: 'Deniz Kıyısı', category: 'Sahil', c1: '#1c7484', c2: '#bfe6ec', dark: false },
  { key: 'tropikal', name: 'Tropikal', category: 'Sahil', c1: '#136443', c2: '#bfe6cf', dark: true },
...
const CATEGORIES = ['Tümü', 'Düğün', 'Kır', 'Bahçe', 'Sahil'];
            ...
            {filtered.map((tpl) => (
              ...
              >
                <div className="tc-image-wrapper" style={{ background: `linear-gradient(135deg, ${tpl.c1}, ${tpl.c2})` }}>
                  <span className="tc-monogram" style={{ color: tpl.dark ? tpl.c2 : '#ffffff' }}>♥</span>
