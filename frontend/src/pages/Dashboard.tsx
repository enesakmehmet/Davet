...
const THEME_GRAD: Record<string, string> = {
  ...
  yildizharitasi: 'linear-gradient(135deg,#080b18,#9bb8ff)', gazete: 'linear-gradient(135deg,#f6f2e6,#8a8578)',
  biniskarti: 'linear-gradient(135deg,#0e5a8a,#dce9f2)', mumisigi: 'linear-gradient(135deg,#120a04,#e8b45a)',
  sakurazen: 'linear-gradient(135deg,#c96f87,#faf7f4)', askmektubu: 'linear-gradient(135deg,#8a5a3b,#f9f3e6)',
  filmseridi: 'linear-gradient(135deg,#101010,#e8c15a)', muze: 'linear-gradient(135deg,#7a6a4f,#f4f1ea)',
  parsomen: 'linear-gradient(135deg,#7a4a1f,#f3e6c8)', denizalti: 'linear-gradient(135deg,#062430,#5fd4d0)',
  sinemaafisi: 'linear-gradient(135deg,#0c0a08,#d4af37)', kristal: 'linear-gradient(135deg,#6f93c9,#f8fafd)',
  pusula: 'linear-gradient(135deg,#3d6b5c,#f2ead8)', sato: 'linear-gradient(135deg,#120c22,#c9a86e)',
  notakagidi: 'linear-gradient(135deg,#4a4440,#faf7f0)', gunbatimi: 'linear-gradient(135deg,#f2825e,#7a4a78)',
  yagliboya: 'linear-gradient(135deg,#8a4a5e,#f5efe4)', ayna: 'linear-gradient(135deg,#7a8294,#f5f6f8)',
...
const PanelView = ({ invitations, totalRsvp, totalViews, viewsMap, recentGuests, onGo }: any) => {
      ...
      >
        {inView && (
          <iframe
            title="thumbnail"
            loading="lazy"
            src={`/davet-preview.html?v=20260829c&thumb=1#cfg=${btoa(unescape(encodeURIComponent(JSON.stringify(inv?.config || {}))))}`}
